...
public class BorderLayoutInJava {
    ...
    public static void main(String[] args) {
        // LayoutManager = Defines the natural layout for componants within a container

        // 3 comon manegers

        // BorderLayout = A borderLayout places componanets in five areas: NORTH, SOUTH, WEST, EAST, CENTER.
        // All extra place is placed in the center area 
